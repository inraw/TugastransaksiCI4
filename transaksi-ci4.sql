...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Bulan Mei 2024 pada 10.19
...
(7, 'Warni', '085649029199', ''),
(8, 'Warni', '085649029199', '');
...
(16, 12, 3, 1, 10000000, 10000000),
(17, 12, 4, 2, 9000000, 18000000);
...
(12, 5, 'TRX371515051020', '2024-05-10', 28000000, 100, 11, 3080000);
...
--
ALTER TABLE `transaksi_header`
  MODIFY `id_transaksi_header` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
